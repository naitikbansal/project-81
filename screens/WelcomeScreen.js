    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Text style={{color:'yellow', fontSize:18, fontWeight:'bold',marginLeft:0}}>USERNAME</Text>
          ...
          <Text style={{color:'yellow', fontSize:18, fontWeight:'bold',marginLeft:0}}>PASSWORD</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
